...
@Slf4j
public class AhamoMonitorExecutor {

  private AhamoStoreMonitor monitor;
  ...
  public void init() throws IOException, URISyntaxException {
    ...
    monitor = new AhamoStoreMonitor();
    monitor.loadParts(this.getClass().getResourceAsStream("/ahamo-part.properties"));
    monitor.loadProps(this.getClass().getResourceAsStream("/ahamo.properties"));
  ...
  public static void main(String[] args) throws Exception {
    AhamoMonitorExecutor client = new AhamoMonitorExecutor();
    client.init();
    client.dumpInfoLoop();
  }
}
